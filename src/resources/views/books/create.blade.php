<x-app-layout>
    <div class="max-w-3xl mx-auto px-6 py-12">
        ...
        <form action="{{ route('books.store') }}" method="post" class="mt-8 space-y-8">
                ...
                <div class="px-6 py-6 space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="author" id="author" value="{{ old('author') }}" placeholder="著者名" required class="block w-full mt-2 px-4 py-3 bg-grau-50 border border-gray-200 rounded-lg text-gray-900 placeholder-gray-400 focus:border-secondary focus:ring-secondary">
                        ...
                        <div>
                            ...
                            <input type="text" name="publisher" id="publisher" value="{{ old('publisher') }}" placeholder="出版社名" class="block w-full mt-2 px-4 py-3 bg-grau-50 border border-gray-200 rounded-lg text-gray-900 placeholder-gray-400 focus:border-secondary focus:ring-secondary">
            ...
            {{-- 読書期間（２カラム） --}}
            <section class="bg-white border border-gray-200 rounded-2xl overflow-hidden">
                <h2 class="px-6 py-3 bg-green-50 text-gray-700 font-bold">読書期間</h2>
                <div class="px-6 py-6 space-y-6">
                    <div class="grid grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="date" name="started_at" id="staretd_at" value="{{ old('started_at') }}" class="block w-full mt-2 px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-900 focus:border-secondary focus:ring-secondary">
                        ...
                        <div>
                            ...
                            <input type="date" name="finished_at" id="finished_at" value="{{ old('finished_at') }}" class="block w-full mt-2 px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-900 focus:border-secondary focus:ring-secondary">
            ...
            <section class="bg-white border border-gray-200 rounded-2xl overflow-hidden">
                ...
                <div class="px-6 py-6 space-y-6">
                    <div>
                        ...
                        <textarea name="summary" id="sumarry" rows="4" placeholder="本の要約を入力してください" class="block w-full mt-2 px-4 py3 bg-gray-200 border border-gray-200 rounded-lg text-gray-900 placeholder:text-gray-400 focus:border-secondary focus:ring-secondary">{{ old('summary') }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea name="memo" id="memo" rows="4" placeholder="感じたこと・気づきなど自由に記録してください" class="block w-full mt-2 px-4 py3 bg-gray-200 border border-gray-200 rounded-lg text-gray-900 placeholder:text-gray-400 focus:border-secondary focus:ring-secondary">{{ old('memo') }}</textarea>
