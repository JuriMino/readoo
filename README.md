...
| **Action**    | 本から得た気づきや知識を、5W1Hで具体的な行動計画として記録 |
...
| **Action** | 本から得た気づきやKnowledgeを、5W1H（いつ・どこで・誰に・何を・なぜ・どうやって）で具体的な行動計画として記録。必ずBookに紐づき、必要に応じてKnowledgeとも関連付け可能 |
...
- Knowledgeを削除しても、関連付けられていたActionをBookに紐づけたまま保持
- ユーザー退会時の関連データ削除
- 同一メールアドレスでの再登録
...
Knowledgeを削除しても、そのKnowledgeに関連付けられていたActionは削除せず、Bookに紐づいた独立した行動として残します。
